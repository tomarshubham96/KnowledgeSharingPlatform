...
class QuillEditor extends React.Component {
    ...
    handleChange = (html) => {
        ...
        this.setState({
            ...
            this.props.handleEditorContentChange(this.state.editorHtml);
        });
    };
    ...
    insertImage = (e) => {
        ...
        if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
            ...
            const quill = this.reactQuillRef.getEditor();
                        ...
                        quill.insertEmbed(position, "image", { src: "", alt: "response.data.fileName" });
                        quill.setSelection(position + 1);

                        if (this._isMounted) {
                            this.setState({
                                files: [...this.state.files, file]
                            }, () => { this.props.handleEditorFilesChange(this.state.files) });
                        }
        }
    };
