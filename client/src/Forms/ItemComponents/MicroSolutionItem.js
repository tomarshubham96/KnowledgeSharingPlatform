...
export default function MicroSolutionItem(props) {
      ...
      <Grid container spacing={1}>
        <Grid container item xs={12}>
            <FormControl className={clsx(classes.margin, classes.textField)}>
              <TextField 
              name="microSolutionTitle" 
              id="microSolutionTitle" 
              label="MicroSolution Title*" 
              value={''} 
              classes={{
          ...
          <Grid container item xs={12}>
            <FormControl className={clsx(classes.margin, classes.textField)}>
              <TextField 
              name="microSolutionDesc" 
              id="microSolutionDesc" 
              label="Description*" 
              value={''} 
              classes={{
                root: classes.labeltext
