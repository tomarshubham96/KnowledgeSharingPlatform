...
import IndustryLearningCard from './IndustryLearningCard';
        ...
        <>
            {title !== 'See All' ? (
                <div className={classes.row}>
                    ...
                    >
                        {projects.map((project) => (
                            ...
                            >
                                <IndustryLearningCard
                                    industryLearning={project}
                                />
                            </Grid>
                        ))}
                    </Grid>
                ...
                <div className={classes.row}>
                    ...
                    >
                        {projects.map((industryLearning) => (
                            <Grid
                                item
                                key={industryLearning.id}
                                lg={4}
                                md={8}
                                sm={12}
                                xs={12}
                            ...
                            >
                                <IndustryLearningCard
                                    industryLearning={industryLearning}
                                />
                            </Grid>
                        ))}
                    </Grid>
